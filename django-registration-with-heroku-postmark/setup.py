...
setup(name='django-registration',
      ...
      author='Jacek Bzdak',
      url='http://bitbucket.org/jbzdak/django-registration-merge-repo',
      download_url='https://bitbucket.org/jbzdak/django-registration-merge-repo/get/jbzdak-merge-python3.3.tar.gz',
