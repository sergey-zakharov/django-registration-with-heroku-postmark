...
setup(name='django-registration',
      ...
      author='Sergey Zakahrov',
      url='http://github.com/sergey-zakharov/django-registration-with-heroku-postmark',
      download_url='https://github.com/sergey-zakharov/django-registration-with-heroku-postmark/archive/master.zip',
